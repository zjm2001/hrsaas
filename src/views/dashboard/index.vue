      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">{{ dateState }} , {{ name }}，祝你开心每一天！</p>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第20期“传智大讲堂”互动讨论获奖名单公布</p>
                      <p>2023-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">文职人员</span> 发布了 第2期“传智大讲堂”我爱好的卡是开发喝咖啡好看</p>
                      <p>2023-07-21 18:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/head.jpeg" alt="">
                    <div>
                      <p><span class="col">打算考较好的靠撒谎</span> 发布了 都是大家挥洒的境况撒花开放</p>
                      <p>2023-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
