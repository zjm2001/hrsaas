<template>
  <div>
    <el-row type="flex" justify="end">
      <el-select v-model="currentYear" size="small" style="width:120px" @click="dateChange" />
      <el-select v-model="currentMonth" size="small" style="width:120px;margin-left:10px" @click="dateChange">
